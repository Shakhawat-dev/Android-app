...
public class Current_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rewardedAd =  utilities.loadRewardAd(Current_Activity.this);
        interstitialAd = utilities.loadIntersitalAd(Current_Activity.this) ;
                        ...
                        viewHolder.setOnClickListener(new ViewHolder.ClickListener() {
                            ...
                            public void onItemClick(View view,final int position) {
                                ...
                                if(home.getAuthra())
                                {
                                    ...
                                    utilities.sendToDesiredActivity(bises_post_detail.class , Current_Activity.this , mTitle , mDesc);
    ...
    private void showPaymentDialog() {
        dialog =  new PrettyDialog(Current_Activity.this) ;
                        ...
                        new PrettyDialogCallback() {  // button OnClick listener
                            ...
                            public void onClick() {
                                ...
                                if(FirebaseAuth.getInstance().getCurrentUser() != null)
                                {
                                    ...
                                    Intent  o = new Intent(Current_Activity.this , packageList.class );
                                    startActivity(o);

                                }
                                else {

                                    Intent  o = new Intent(Current_Activity.this , loginactivity.class );
                                    startActivity(o);
                                }
                            }
                        }
...
//                                            , Toast.LENGTH_SHORT).show();
                            ...
                            rewardedAd.show(Current_Activity.this, adCallback);
                        }
                        else {
                            ...
                            if(interstitialAd.isLoaded())
                            {
                                ...
                                utilities.loadRewardAd(Current_Activity.this);
