...
public class career_prep_Bangladesh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_career_prep__bangladesh);
...
//spinner
        spinner =  findViewById(R.id.progressBar_carrer_prep_BD);
        ...
        mRef = mFirebaseDatabase.getReference("career_prep_Bangladesh");
    }
    //search data
