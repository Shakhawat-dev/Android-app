...
public class Under_Bcs_prep_Button extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rewardedAd =  utilities.loadRewardAd(Under_Bcs_prep_Button.this);
        interstitialAd = utilities.loadIntersitalAd(Under_Bcs_prep_Button.this);




//spinner
        spinner =  findViewById(R.id.progressBar_Under_BcsButton_prep);
        spinner.setVisibility(View.VISIBLE);
        drawerLayout = findViewById(R.id.drawerId_under_bcs_button);
        navigationView=findViewById(R.id.NAVVIew_ID_under_bcs_Button);
        ...
        mRef = mFirebaseDatabase.getReference("Bcs_prep_All");
    }
    //search data
                              ...
                              //  TextView mTitleTv = view.findViewById(R.id.rTitleTv__Career_prep_by_subject);
                               // TextView mDescTv = view.findViewById(R.id.rDescriptionTv_Career_prep_by_subject);
                                ...
                                if(home.getAuthra())
                                {
                                    ...
                                    utilities.sendToDesiredActivity(postDetails_for_Career_prep_by_subject.class , Under_Bcs_prep_Button.this , mTitle , mDesc);
    ...
    private void showPaymentDialog() {
        dialog =  new PrettyDialog(Under_Bcs_prep_Button.this) ;
                        ...
                        new PrettyDialogCallback() {  // button OnClick listener
                            ...
                            public void onClick() {
                                ...
                                if(FirebaseAuth.getInstance().getCurrentUser() != null)
                                {
                                    ...
                                    Intent  o = new Intent(Under_Bcs_prep_Button.this , packageList.class );
                                    startActivity(o);

                                }
                                else {

                                    Intent  o = new Intent(Under_Bcs_prep_Button.this , loginactivity.class );
                                    startActivity(o);
                                }
                            }
                        }
                            ...
                            RewardedAdCallback adCallback = new RewardedAdCallback() {
                                ...
                                public void onRewardedAdClosed() {
                                    ...
                                    if (rewardd == 0 ) {
                                        ...
                                        utilities.sendToDesiredActivity(Voc_post_detail.class , Under_Bcs_prep_Button.this , mTitle , mDesc);
                                    }
                                }
...
//                                            , Toast.LENGTH_SHORT).show();
                            ...
                            rewardedAd.show(Under_Bcs_prep_Button.this, adCallback);
                        }
                        else {
                            ...
                            if(interstitialAd.isLoaded())
                            {
                                ...
                                utilities.loadRewardAd(Under_Bcs_prep_Button.this);
