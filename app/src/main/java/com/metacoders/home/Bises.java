...
public class Bises extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bises);

        drawerLayout = findViewById(R.id.drawerId_bises);
        navigationView=findViewById(R.id.NAVVIew_ID_bises);

        toggle = new ActionBarDrawerToggle(this,drawerLayout ,R.string.nav_open ,R.string.nav_close );

        home = new Home_Activity();
        utilities = new utilities() ;
        rewardedAd =  utilities.loadRewardAd(Bises.this);
        interstitialAd = utilities.loadIntersitalAd(Bises.this) ;
        ...
        mRef = mFirebaseDatabase.getReference("Bises");
    }
    //search data
                        ...
                        viewHolder.setOnClickListener(new ViewHolder.ClickListener() {
                            ...
                            public void onItemClick(View view, final  int position) {
                                ...
                                if(home.getAuthra())
                                {
                                    ...
                                    utilities.sendToDesiredActivity(bises_post_detail.class , Bises.this , mTitle , mDesc);
    ...
    private void showPaymentDialog() {
        dialog =  new PrettyDialog(Bises.this) ;
                        ...
                        new PrettyDialogCallback() {  // button OnClick listener
                            ...
                            public void onClick() {
                                ...
                                if(FirebaseAuth.getInstance().getCurrentUser() != null)
                                {
                                    ...
                                    Intent  o = new Intent(Bises.this , packageList.class );
                                    startActivity(o);

                                }
                                else {

                                    Intent  o = new Intent(Bises.this , loginactivity.class );
                                    startActivity(o);
                                }
                            }
                        }
...
//                                            , Toast.LENGTH_SHORT).show();
                            ...
                            rewardedAd.show(Bises.this, adCallback);
                        }
                        else {
                            ...
                            if(interstitialAd.isLoaded())
                            {
                                ...
                                utilities.loadRewardAd(Bises.this);
