...
public class Editorial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rewardedAd =  utilities.loadRewardAd(Editorial.this);
        interstitialAd = utilities.loadIntersitalAd(Editorial.this) ;

//spinner
        pbar =  findViewById(R.id.progresBar_Editorail);
        pbar.setVisibility(View.VISIBLE);

        drawerLayout = findViewById(R.id.DrawerId_Editorial);
        navigationView=findViewById(R.id.NAVVIew_ID_editrial);
        ...
        mRef = mFirebaseDatabase.getReference("Editorial");
    }
    //search data
                        ...
                        viewHolder.setOnClickListener(new ViewHolder.ClickListener() {
                            ...
                            public void onItemClick(View view,final  int position) {
                                if(home.getAuthra())
                                {
                                    ...
                                    utilities.sendToDesiredActivity(Voc_post_detail.class , Editorial.this , mTitle , mDesc);
    ...
    private void showPaymentDialog() {
        dialog =  new PrettyDialog(Editorial.this) ;
                        ...
                        new PrettyDialogCallback() {  // button OnClick listener
                            ...
                            public void onClick() {
                                ...
                                if(FirebaseAuth.getInstance().getCurrentUser() != null)
                                {
                                    ...
                                    Intent  o = new Intent(Editorial.this , packageList.class );
                                    startActivity(o);

                                }
                                else {

                                    Intent  o = new Intent(Editorial.this , loginactivity.class );
                                    startActivity(o);
                                }
                            }
                        }
...
//                                            , Toast.LENGTH_SHORT).show();
                            ...
                            rewardedAd.show(Editorial.this, adCallback);
                        }
                        else {
                            ...
                            if(interstitialAd.isLoaded())
                            {
                                ...
                                interstitialAd.setAdListener(new AdListener(){
                                    ...
                                    public void onAdClosed() {
                                        ...
                                        utilities.sendToDesiredActivity(bises_post_detail.class , Editorial.this , mTitle , mDesc);
                                    }
                                });

                            }
                            else {
                                utilities.loadRewardAd(Editorial.this);
