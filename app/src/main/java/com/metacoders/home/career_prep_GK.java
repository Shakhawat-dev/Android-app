...
public class career_prep_GK extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_career_prep__gk);
...
//spinner
        spinner =  findViewById(R.id.progressBar_carrer_prep_GK);
        ...
        mRef = mFirebaseDatabase.getReference("career_prep_Gk");
    }
    //search data
